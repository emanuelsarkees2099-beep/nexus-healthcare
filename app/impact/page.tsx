  ...
  return (
    <AppShell>
      ...
      <section style={{ minHeight: '80dvh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', padding: '100px 24px 60px', position: 'relative', overflow: 'hidden' }}>
        ...
        <p style={{ fontSize: '13px', color: 'rgba(74,144,217,0.6)', letterSpacing: '0.04em' }}>Data updated every 4 hours · Last updated 2 hours ago</p>
      </section>
                  ...
                  <div style={{ background: '#080D1A', borderRadius: '18px', padding: '32px 28px' }}>
                    ...
                    <div style={{ marginTop: '16px', height: '28px', display: 'flex', alignItems: 'flex-end', gap: '3px' }}>
                      {Array.from({ length: 12 }, (_, j) => (
                        <div key={j} style={{ flex: 1, borderRadius: '2px', background: 'rgba(74,144,217,0.2)', height: `${30 + Math.sin(j * 0.8 + i) * 20}%`, transition: `height 0.8s cubic-bezier(0.16,1,0.3,1) ${j * 40}ms` }} />
                      ))}
                    </div>
                  </div>
                </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
            ...
            <RevealBlock delay={200}>
              <div style={{ padding: '28px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '18px' }}>
                ...
                <AnimBar pct={94} color='#60a5fa' label='Received care within 7 days' />
            ...
            {REGIONS.map((r, i) => (
              <RevealBlock key={r.region} delay={i * 70}>
                <div style={{ padding: '24px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '16px', transition: 'border-color 0.25s, background 0.25s' }}
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(74,144,217,0.22)'; (e.currentTarget as HTMLElement).style.background = 'rgba(74,144,217,0.04)' }}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            {METHODOLOGY.map((m, i) => (
              <RevealBlock key={i} delay={i * 60}>
                <div style={{ borderRadius: '16px', overflow: 'hidden', border: '1px solid', borderColor: openMethod === i ? 'rgba(74,144,217,0.25)' : 'rgba(255,255,255,0.06)', background: openMethod === i ? 'rgba(74,144,217,0.04)' : 'transparent', transition: 'all 0.25s', marginBottom: '4px' }}>
                  <button
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '16px' }}>
            {[
              ...
              <RevealBlock key={d.name} delay={i * 80}>
                <div style={{ padding: '2px', background: 'linear-gradient(135deg, rgba(74,144,217,0.15), rgba(74,144,217,0.04))', borderRadius: '18px' }}>
                  <div style={{ background: '#080D1A', borderRadius: '16px', padding: '24px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                      <span style={{ fontSize: '11px', padding: '3px 10px', borderRadius: '100px', background: 'rgba(74,144,217,0.08)', border: '1px solid rgba(74,144,217,0.18)', color: 'var(--accent)', fontWeight: 500 }}>{d.format}</span>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '12px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                      ...
                      <button
                        ...
                        style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '7px 14px', borderRadius: '100px', background: 'rgba(74,144,217,0.1)', border: '1px solid rgba(74,144,217,0.2)', color: 'var(--accent)', fontSize: '12px', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', transition: 'background 0.2s' }}
