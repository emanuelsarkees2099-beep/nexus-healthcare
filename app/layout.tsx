...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${process.env.NEXT_PUBLIC_APP_URL ?? 'https://axvo.health'}/api/og`, width: 1200, height: 630, alt: 'AXVO — Free Healthcare, Found in Seconds' }],
  },
  twitter: {
    ...
    title: 'AXVO — Free Healthcare, Found in Seconds',
    description: 'Find free clinics, sliding-scale care, and eligibility programs near you. No insurance required.',
    images: [`${process.env.NEXT_PUBLIC_APP_URL ?? 'https://axvo.health'}/api/og`],
  },
}
