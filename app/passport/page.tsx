...
function ShareableSummary({ passport, masked }: { passport: Passport; masked: boolean }) {
  ...
  const summary = [
    `AXVO Care Summary — ${new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}`,
    ...
    `Generated by AXVO Health · axvohealth.com/passport`,
  ].join('\n')
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'My AXVO Care Summary',
          text: summary,
          url: 'https://www.axvohealth.com/passport',
        })
...
const REFILL_KEY = 'axvo_refill_dates'
...
/* ── Vaccine Tracker ───────────────────────────────────────────── */
const VACCINE_KEY = 'axvo_passport_vaccines'
...
const PASSPORT_KEY = 'axvo_passport'
    ...
    <AppShell>
      ...
      <section style={{
        ...
        <p style={{
          ...
          Store your allergies, medications, and conditions. Generate a one-page summary for any clinic visit. End-to-end encrypted — AXVO cannot read your data.
        </p>
        <div style={{
                ...
                {[
                  ...
                  <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{
                      ...
                      background: entry.color, border: `2px solid rgba(5,6,9,1)`,
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.4)', lineHeight: 1.7, margin: 0 }}>
              Your Health Passport is encrypted on your device before it ever reaches our servers. We use AES-256 encryption with a key only you hold. AXVO employees cannot read your health data — even if we wanted to. You can delete your passport at any time, permanently.
            </p>
