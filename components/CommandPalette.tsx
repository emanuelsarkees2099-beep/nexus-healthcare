...
const CMD_ITEMS: CmdItem[] = [
  ...
  },
  {
    ...
    href: '/programs',
    icon: <ReceiptText size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Core',
  ...
  },
  {
    ...
    href: '/chw',
    icon: <Profile2User size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Core',
  ...
  },
  {
    ...
    href: '/pathways',
    icon: <Cpu size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Features',
  ...
  },
  {
    ...
    href: '/outcomes',
    icon: <Chart2 size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Features',
  ...
  },
  {
    ...
    href: '/calendar',
    icon: <Calendar1 size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Features',
  ...
  },
  {
    ...
    href: '/telehealth',
    icon: <Call size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Features',
  ...
  },
  {
    ...
    href: '/stories',
    icon: <Book1 size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Community',
  ...
  },
  {
    ...
    href: '/rights',
    icon: <Judge size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Community',
  ...
  },
  {
    ...
    href: '/advocacy',
    icon: <Speaker size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Community',
  ...
  },
  {
    ...
    href: '/accessibility',
    icon: <Eye size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Info',
  ...
  },
  {
    ...
    href: '/dashboard',
    icon: <Heart size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Account',
  ...
  },
  {
    ...
    href: '/equity',
    icon: <Global size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Info',
  ...
  },
  {
    ...
    href: '/gps',
    icon: <Routing size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Features',
  ...
  },
  {
    ...
    href: '/passport',
    icon: <ShieldTick size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Account',
  ...
  },
  {
    ...
    href: '/crisis',
    icon: <Danger size={15} variant="Linear" color="#f87171" />,
    category: 'Core',
  ...
  },
  {
    ...
    href: '/wrapped',
    icon: <MagicStar size={15} variant="Linear" color="var(--text-2)" />,
    category: 'Account',
  ...
  },
  {
    ...
    href: '/onboarding',
    icon: <ArrowRight size={15} variant="Linear" color="var(--accent)" />,
    category: 'Core',
      ...
      <div className="cmd-panel" onClick={e => e.stopPropagation()}>
        ...
        <div className="cmd-input-row">
          ...
          {voiceSupported && (
            ...
            >
              {listening ? <MicrophoneSlash size={14} variant="Linear" color="#f87171" /> : <Microphone size={14} variant="Linear" color="var(--text-2)" />}
            </button>
          )}
          <kbd style={{
