    ...
    const draw = () => {
      ...
      for (let r = 0; r <= rows; r++) {
        for (let c = 0; c <= cols; c++) {
          ...
          ctx.fillStyle = `rgba(74,144,217,${0.035 + wave * 0.04})`
          ctx.fill()
        }
      }
      ...
      glows.forEach(g => {
        ...
        grad.addColorStop(0,   'rgba(74,144,217,0.06)')
        grad.addColorStop(0.5, 'rgba(74,144,217,0.02)')
  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" style={{
        ...
        background: 'radial-gradient(ellipse, rgba(74,144,217,0.05) 0%, transparent 70%)',
        ...
        >
          ...
          >
            <defs>
              <linearGradient id="conn-grad" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                <stop offset="40%"  stopColor="rgba(74,144,217,0.22)" />
                <stop offset="60%"  stopColor="rgba(74,144,217,0.22)" />
          ...
          {MINOR_CITIES.map((c, i) => (
            <div key={i} aria-hidden="true" style={{
              ...
              boxShadow: '0 0 4px rgba(74,144,217,0.15)',
              zIndex: 2,
            }} />
          ))}
          ...
          {MAJOR_CITIES.map(city => (
            ...
            >
              ...
              <div aria-hidden="true" style={{
                ...
                boxShadow: `0 0 ${hoveredCity === city.id ? 16 : 8}px rgba(74,144,217,${hoveredCity === city.id ? 0.9 : 0.6})`,
